...
UkrTube — це розширення Chrome на основі Manifest V3. Воно додає вкладку **UkrTube** з українськими відео на головну сторінку YouTube. У вкладці є нескінченна стрічка та фільтри за темами, словами й датою.

## Можливості

- Вкладка **UkrTube** на головній сторінці YouTube.
- Нескінченне гортання без повторів між сторінками.
- Фільтри за темами, словами й датою для всього каталогу на сервері.
- Картки з назвою, каналом, зображенням, тривалістю, переглядами й датою.
- Поступове отримання аватара каналу й переглядів, якщо їх ще немає в каталозі.
...
- Доступ до служби стрічки потрібен для завантаження сторінок каталогу.
